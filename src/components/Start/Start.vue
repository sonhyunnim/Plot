      ...
      <div class="start-page-warpper">
        <div class="start-page-center">
          ...
          <div class="start-button-warpper">
            <a href class="start-login-facebook-link" @click.prevent="facebookLink">
              <span class="fa fa-facebook-official" aria-hidden="true"></span>
              <span class="facebook-login">페이스북 로그인</span>
            </a>
            <a href class="start-page-login-link" @click.prevent="loginLink"><span class="login">로그인</span></a>
            <a href class="start-join-link" @click.prevent="joinLink"><span class="join">회원가입</span></a> 
          </div>
	    </div>
      </div>
    </div>
...
<style lang="sass">
  ...
  .service-msg
    ...
    line-height: 1.7
    color: #ffffff
    padding-left: span(3.2)

  .start-button-warpper
    +span(4)
    // background: pink
    padding-left: span(3.32)
    // margin-bottom: leading(1)

  // 페이스북 로그인 버튼 
  .start-login-facebook-link
    width: 172px
    height: 41px
